use crate::interpreter::ast::{parser::Parser, WhereStackElement, WhereStackOperators, Parentheses, LogicalOperator};
use crate::interpreter::tokenizer::token::TokenTypes;
use crate::interpreter::ast::helpers::where_clause::where_condition::get_condition;


pub fn get_where_stack_element(parser: &mut Parser, operator_stack: &Vec<WhereStackOperators>) -> Result<Option<WhereStackElement>, String> {
