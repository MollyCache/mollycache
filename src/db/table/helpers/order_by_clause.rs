...
#[cfg(test)]
mod tests {
    use crate::db::table::{ColumnDefinition, DataType, Row, RowStack, Table, Value};
        ...
        Table {
            ...
            rows: vec![
                RowStack::new(Row(vec![
                    Value::Integer(3),
                    Value::Text("c_Jim".to_string()),
                    Value::Real(3000.0),
                    Value::Blob(b"0022".to_vec()),
                ])),
                RowStack::new(Row(vec![
                    Value::Integer(1),
                    Value::Text("a_John".to_string()),
                    Value::Real(1000.0),
                    Value::Blob(b"0000".to_vec()),
                ])),
                RowStack::new(Row(vec![
                    Value::Null,
                    Value::Null,
                ...
                RowStack::new(Row(vec![
                    Value::Integer(2),
                    Value::Text("b_Jane".to_string()),
                    Value::Real(2000.0),
                    Value::Blob(b"0201".to_vec()),
                ])),
                RowStack::new(Row(vec![
                    Value::Integer(3),
                    Value::Text("b_Jim".to_string()),
                    Value::Real(1500.0),
                    Value::Blob(b"0102".to_vec()),
                ])),
                RowStack::new(Row(vec![
                    Value::Integer(4),
                    Value::Text("a_Jim".to_string()),
                    Value::Real(500.0),
                    Value::Blob(b"0101".to_vec()),
                ])),
                RowStack::new(Row(vec![
                    Value::Integer(1),
                    Value::Text("a_Jim".to_string()),
                    Value::Real(5000.0),
                    Value::Blob(b"0401".to_vec()),
                ])),
            ],
        }
    }
